        ...
        <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
                <div class="overlay-text">
                    <h1 class="fw-light">Jelajahi Buku dan Beritahu Temanmu</h1>
                    <p class="lead">Komunitas untuk pecinta Buku</p>
                </div>
            </div>
        </div>
        <!-- Slide 2 -->
            ...
            <div class="container-fluid">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
                    <div class="col">
                        ...
                        <img src="./foto/foto-film/670f30e72ef30.jpg" class="bd-placeholder-img card-img-top" alt="" style="width: 100%; height: 225px; object-fit: contain;" />
                            <div class="card-body">
                                <h4>Pluto</h4>
                                <p class="card-text">
                                    lorem
                                </p>
                                <small class="text-body-secondary">Rating: 9/10</small>
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <a href="detail-buku.php" class="btn btn-sm btn-outline-primary">Baca Selengkapnya</a>
